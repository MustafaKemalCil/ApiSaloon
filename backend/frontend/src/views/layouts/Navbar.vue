    ...
    <nav class="text-gray-800 shadow-md bg-[#C1B16E]">
      ...
      <div class="hidden md:flex justify-end items-center w-full bg-[#AA9A5A] text-gray-900 text-sm">
        <div class="container flex justify-end items-center px-6 py-2 mx-auto space-x-6">
          ...
          <a href="https://wa.me/905551112233" target="_blank" class="flex items-center hover:text-gray-700 transition">
            💬 <span class="ml-1 font-medium">WhatsApp</span>
          </a>
          <a href="https://instagram.com" target="_blank" class="flex items-center hover:text-gray-700 transition">
  ...
  import logoImg from '@/assets/images/logo.png' // veya doğru yolu kullan
  ...
  const links = [
    ...
    { name: 'Giriş', href: '/Admin/Dashboard' },
  ]
